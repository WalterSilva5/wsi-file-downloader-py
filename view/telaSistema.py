...
"")
        ...
        self.entradaLinkDeDownload.setGeometry(QtCore.QRect(230, 20, 381, 31))
...
"")
        ...
        self.progresso.setGeometry(QtCore.QRect(210, 140, 531, 31))
...
"border-radius: 5px;")
        ...
        self.entradaDestino.setGeometry(QtCore.QRect(230, 60, 381, 31))
...
"border-radius: 5px;")
        ...
        self.labelLink_4.setGeometry(QtCore.QRect(10, 140, 221, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
